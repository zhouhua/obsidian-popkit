...
export const sortedList: Action = {
  id: 'sorted-list',
  version: 0,
  name: 'ordered list',
...
export const mergeLines: Action = {
  id: 'merge-lines',
  version: 0,
  name: 'merge lines',
...
export const reverseLine: Action = {
  id: 'reverse-lines',
  version: 0,
  name: 'reverse lines',
...
export const shuffleLine: Action = {
  id: 'shuffle-lines',
  version: 0,
  name: 'shuffle lines',
